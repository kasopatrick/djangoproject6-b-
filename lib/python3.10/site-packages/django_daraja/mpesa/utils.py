...
def generate_access_token_request(consumer_key = None, consumer_secret = None):
	...
	consumer_key = consumer_key if consumer_key is not None else 'g2iBGzRo2gAGEo3aeGUYjGosnAp0r2dr'
	consumer_secret = consumer_secret if consumer_secret is not None else 'TZGkOCJgfuQgCZoi'
